...
import site.mtnsj.core.listeners.TransactionConfidenceEventListener;
import site.mtnsj.core.AbstractBlockChain;
import site.mtnsj.core.Address;
import site.mtnsj.core.Block;
import site.mtnsj.core.BlockChain;
import site.mtnsj.core.Coin;
import site.mtnsj.core.ECKey;
import site.mtnsj.core.InsufficientMoneyException;
import site.mtnsj.core.PeerAddress;
...
import site.mtnsj.core.TransactionOutPoint;
import site.mtnsj.core.TransactionOutput;
import site.mtnsj.core.Utils;
import site.mtnsj.core.VerificationException;
import site.mtnsj.core.TransactionConfidence.ConfidenceType;
import site.mtnsj.crypto.*;
import site.mtnsj.script.Script;
import site.mtnsj.script.ScriptBuilder;
import site.mtnsj.signers.StatelessTransactionSigner;
import site.mtnsj.signers.TransactionSigner;
import site.mtnsj.store.BlockStoreException;
import site.mtnsj.store.MemoryBlockStore;
import site.mtnsj.testing.*;
import site.mtnsj.utils.ExchangeRate;
import site.mtnsj.utils.Fiat;
import site.mtnsj.utils.Threading;
import site.mtnsj.wallet.Wallet.BalanceType;
import site.mtnsj.wallet.WalletTransaction.Pool;
...
import static site.mtnsj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: mtnsj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("mtnsj-unit-test", null);
