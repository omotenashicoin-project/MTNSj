...
import site.mtnsj.crypto.LazyECPoint;
import site.mtnsj.crypto.MnemonicCode;
import site.mtnsj.crypto.MnemonicException;
import site.mtnsj.net.discovery.PeerDiscovery;
import site.mtnsj.net.discovery.PeerDiscoveryException;
...
public class MatiTest {
    ...
    public void connectTestnetPeer(){
        ...
        Peer peer = new Peer(networkParameters,versionMessage,new PeerAddress("localhost",48985),null);
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_MTNS_ONLY
        );
    ...
    public Wallet restore(NetworkParameters networkParameters) throws IOException {
        String filename = "2.0.32_mtns-wallet-backup_site.mtns.production-2017-11-20";
        //"1.01_mtns-wallet-backup_site.mtns.production-2017-07-26 (2)";
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_MTNS_ONLY);
        ...
        peerGroup.addPeerDiscovery(new PeerDiscovery() {
            ...
            public InetSocketAddress[] getPeers(long services, long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
                return new InetSocketAddress[]{
                        new InetSocketAddress("localhost",48985)
                };
            }
