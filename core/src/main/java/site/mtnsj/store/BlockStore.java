...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link site.mtnsj.core.BlockChain#getChainHead()}
     * or perhaps {@link site.mtnsj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link site.mtnsj.core.NetworkParameters} of this store.
