...
import site.mtnsj.crypto.KeyCrypterScrypt;
import site.mtnsj.script.Script;
import site.mtnsj.signers.LocalTransactionSigner;
 ...
 * format is defined by the <tt>wallet.proto</tt> file in the mtnsj source distribution.<p>
 *
...
public class WalletProtobufSerializer {
    ...
    private WalletTransaction connectTransactionOutputs(final NetworkParameters params,
                                                        final site.mtnsj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
