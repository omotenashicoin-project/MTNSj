...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link site.mtnsj.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the mtnsj protobuf format. */
     ...
     *
     * <p>See the docs for {@link site.mtnsj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
