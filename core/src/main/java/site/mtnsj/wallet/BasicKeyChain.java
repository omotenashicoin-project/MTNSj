...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws site.mtnsj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws site.mtnsj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(site.mtnsj.crypto.KeyCrypter,
