...
import site.mtnsj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(site.mtnsj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link site.mtnsj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link site.mtnsj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
