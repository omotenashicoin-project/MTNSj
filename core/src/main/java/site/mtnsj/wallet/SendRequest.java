...
import site.mtnsj.core.Context;
...
import site.mtnsj.wallet.KeyChain.KeyPurpose;
import site.mtnsj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link site.mtnsj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link site.mtnsj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
