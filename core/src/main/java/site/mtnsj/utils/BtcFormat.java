...
import site.mtnsj.utils.BtcAutoFormat.Style;
import static site.mtnsj.utils.BtcAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link site.mtnsj.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /**
      ...
      * {@link site.mtnsj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
