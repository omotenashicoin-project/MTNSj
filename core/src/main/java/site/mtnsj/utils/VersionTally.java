 ...
 *
 * @see site.mtnsj.core.NetworkParameters#getMajorityWindow()
 * @see site.mtnsj.core.NetworkParameters#getMajorityEnforceBlockUpgrade()
 * @see site.mtnsj.core.NetworkParameters#getMajorityRejectBlockOutdated()
 */
