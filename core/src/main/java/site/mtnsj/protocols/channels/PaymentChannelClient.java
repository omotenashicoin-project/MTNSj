...
import site.mtnsj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link site.mtnsj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
     ...
     * {@link ClientConnection#destroyConnection(site.mtnsj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
