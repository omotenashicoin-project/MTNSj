...
public abstract class ServerConnectionEventHandler {
     ...
     * {@link StoredPaymentChannelServerStates#getChannel(site.mtnsj.core.Sha256Hash)} with the id provided in
     * {@link ServerConnectionEventHandler#channelOpen(site.mtnsj.core.Sha256Hash)}</p>
     */
