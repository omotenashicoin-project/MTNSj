...
/**
 * Network parameters used by the mtnsj unit tests (and potentially your own). This lets you solve a block using
 * {@link site.mtnsj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
