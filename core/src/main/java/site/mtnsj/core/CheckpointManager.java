...
import site.mtnsj.store.FullPrunedBlockStore;
 ...
 * {@link site.mtnsj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with mtnsj */
    ...
    /** Returns a checkpoints stream pointing to inside the mtnsj JAR */
