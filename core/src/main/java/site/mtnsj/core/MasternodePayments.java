...
public class MasternodePayments {
    ...
    static final int MIN_MASTERNODE_PAYMENT_PROTO_VERSION_1 = 70206; //kaniTODO
    ...
    int getMinMasternodePaymentsProto() {
        return context.sporkManager.isSporkActive(SporkManager.SPORK_10_MASTERNODE_PAY_UPDATED_NODES) //kaniTODO
