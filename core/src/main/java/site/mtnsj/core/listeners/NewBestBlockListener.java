...
package site.mtnsj.core.listeners;
...
public interface NewBestBlockListener {
     ...
     * {@link TransactionReceivedInBlockListener#receiveFromBlock(site.mtnsj.core.Transaction, site.mtnsj.core.StoredBlock, site.mtnsj.core.BlockChain.NewBlockType, int relativityOffset)}
     * or {@link TransactionReceivedInBlockListener#notifyTransactionIsInBlock(site.mtnsj.core.Sha256Hash, site.mtnsj.core.StoredBlock, site.mtnsj.core.BlockChain.NewBlockType, int)}.
