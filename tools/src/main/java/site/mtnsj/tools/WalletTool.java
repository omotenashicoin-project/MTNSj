...
package site.mtnsj.tools;

import site.mtnsj.core.*;
import site.mtnsj.crypto.*;
import site.mtnsj.net.discovery.DnsDiscovery;
import site.mtnsj.params.MainNetParams;
import site.mtnsj.params.RegTestParams;
import site.mtnsj.params.TestNet3Params;
import site.mtnsj.protocols.payments.PaymentProtocol;
import site.mtnsj.protocols.payments.PaymentProtocolException;
import site.mtnsj.protocols.payments.PaymentSession;
import site.mtnsj.script.ScriptBuilder;
import site.mtnsj.store.*;
import site.mtnsj.uri.MtnsURI;
import site.mtnsj.uri.BitcoinURIParseException;
import site.mtnsj.utils.BriefLogFormatter;
import site.mtnsj.wallet.DeterministicSeed;
import site.mtnsj.wallet.DeterministicUpgradeRequiredException;
import site.mtnsj.wallet.DeterministicUpgradeRequiresPassword;
...
import site.mtnsj.core.listeners.BlocksDownloadedEventListener;
import site.mtnsj.core.listeners.DownloadProgressTracker;
import site.mtnsj.wallet.MarriedKeyChain;
...
import site.mtnsj.wallet.WalletProtobufSerializer;
import site.mtnsj.wallet.Wallet.BalanceType;
...
import static site.mtnsj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    MtnsURI paymentRequestURI = new MtnsURI(location);
